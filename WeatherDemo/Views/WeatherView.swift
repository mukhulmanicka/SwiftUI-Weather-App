...
//  WeatherDemo
//
//  Created by Mukhul Manicka on 10/9/23.
//
...
struct WeatherView: View {
    ...
    var body: some View {
        ZStack(alignment: .leading) {
            VStack {
                ...
                VStack() {
                    ...
                    AsyncImage(url: URL(string: "https://cdn.pixabay.com/photo/2020/01/24/21/33/city-4791269_1280.png")) { image in image
                            .resizable()
        ...
        .background(Color(hue: 0.562, saturation: 1.0, brightness: 1.0))
